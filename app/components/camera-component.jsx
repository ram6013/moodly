...
const CameraComponent = () => {
    ...
    useEffect(() => {
        Promise.all([
            faceapi.loadSsdMobilenetv1Model("/en/models"),
            faceapi.loadFaceLandmarkModel("/en/models"),
            faceapi.loadFaceRecognitionModel("/en/models"),
            faceapi.loadFaceExpressionModel("/en/models"),
        ]).then(() => {
            setIsLoading(false);
            initVideo();
        }).catch((error) => {
